...
secondhint = {
    ...
    "cat": "Domesticated for thousands of years, it has a strong sense of territory and can be affectionate with its owners anddefinitely not cute.",
...
while not end_of_game and remaining_turns > 0:
    ...
    if not found:
        ...
        if remaining_turns == 4:  # Provide additional hint when 4 turns left
            if chosen_word in hints:
                print("Sencond Hint:", secondhint[chosen_word])
